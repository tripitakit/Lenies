defmodule LeniesWeb.DashboardLiveTest do
  ...
  test "Species panel shows top-N species table from aggregator", %{conn: conn} do
    :ets.insert(Lenies.WorldTestHelpers.lenies(), {"a", %{id: "a", codeome_hash: "hashA", lineage: {nil, 0}}})
    :ets.insert(Lenies.WorldTestHelpers.lenies(), {"b", %{id: "b", codeome_hash: "hashA", lineage: {nil, 1}}})
    :ets.insert(Lenies.WorldTestHelpers.lenies(), {"c", %{id: "c", codeome_hash: "hashB", lineage: {nil, 0}}})
  ...
  describe "inspector dirty notification" do
    ...
    test "closing the inspector (deselect to nil) resets :inspector_dirty", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-Z", lineage: {nil, 0}}})
  ...
  describe "species inspector panel" do
    ...
    test "clicking a species row opens the inspector for that hash", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-X", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L2", %{id: "L2", codeome_hash: "HASH-X", lineage: {nil, 1}}})
    ...
    test "clicking the same row again closes the inspector", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-Y", lineage: {nil, 0}}})
    ...
    test "clicking another row swaps the inspected species", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-A", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L2", %{id: "L2", codeome_hash: "HASH-B", lineage: {nil, 0}}})
  ...
  describe "map highlight driven by selected species" do
    ...
    test "selecting a species row sets the canvas highlight to its hue", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-SEL-A", lineage: {nil, 0}}})
    ...
    test "clicking the selected row again deselects and clears the highlight", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-SEL-B", lineage: {nil, 0}}})
    ...
    test "highlight is cleared when the selected species drops out of the top-N",
      ...
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "HASH-GONE", lineage: {nil, 0}}})
  ...
  describe "species table sorting" do
    ...
    test "defaults to population descending", %{conn: conn} do
      ...
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"H1", %{id: "H1", codeome_hash: "POPHI", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"H2", %{id: "H2", codeome_hash: "POPHI", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"H3", %{id: "H3", codeome_hash: "POPHI", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"L1", %{id: "L1", codeome_hash: "POPLO", lineage: {nil, 0}}})
    ...
    test "sorting by generation descending puts the oldest lineage first", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"Y1", %{id: "Y1", codeome_hash: "YOUNG", lineage: {nil, 1}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"O1", %{id: "O1", codeome_hash: "OLDGEN", lineage: {nil, 9}}})
  ...
  describe "species table — LiveView stream" do
    test "species rows are rendered with the expected stream DOM id", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"S1", %{id: "S1", codeome_hash: "STREAM-HASH-1", lineage: {nil, 0}}})
    ...
    test "species_total count is still displayed after stream conversion", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"T1", %{id: "T1", codeome_hash: "COUNT-A", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"T2", %{id: "T2", codeome_hash: "COUNT-B", lineage: {nil, 0}}})
    ...
    test "select_species re-streams and highlights the selected row", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"HL1", %{id: "HL1", codeome_hash: "HASH-HL", lineage: {nil, 0}}})
    ...
    test "deselecting a row removes the highlight class via re-stream", %{conn: conn} do
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"DH1", %{id: "DH1", codeome_hash: "HASH-DH", lineage: {nil, 0}}})
    ...
    test "sort_species re-streams rows in the new order", %{conn: conn} do
      ...
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"SR1", %{id: "SR1", codeome_hash: "SORTED-HI", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"SR2", %{id: "SR2", codeome_hash: "SORTED-HI", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"SR3", %{id: "SR3", codeome_hash: "SORTED-HI", lineage: {nil, 0}}})
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"SR4", %{id: "SR4", codeome_hash: "SORTED-LO", lineage: {nil, 0}}})
    ...
    test "tick re-streams updated species data", %{conn: conn} do
      ...
      :ets.insert(Lenies.WorldTestHelpers.lenies(), {"TK1", %{id: "TK1", codeome_hash: "TICK-HASH", lineage: {nil, 0}}})
